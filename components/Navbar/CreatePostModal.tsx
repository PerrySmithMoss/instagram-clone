    ...
    >
      ...
      >
        ...
        >
          ...
          <hr />
          <div className={CreatePostModalStyles.createPostModalContentInner}>
            {selectedFile ? (
              <div className="grid grid-cols-2 max-w-4xl h-full">
                <div className=" object-cover overflow-hidden">
                  <img
                    src={selectedFile as string}
                    className=" overflow-hidden object-cover rounded-bl-xl cursor-pointer h-full w-full"
                      ...
                      {isAccessibilityOpen && (
                        <div className="">
                          <p className="text-sm text-gray-500">
                            ...
                            visual impairments. Alt text will be automatically
                            created for your photos or you can choose to write
                            your own.
                          </p>
